      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <header className="h-16 flex items-center justify-between px-4 md:px-8 border-b border-border bg-background z-40 sticky top-0 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/create" className="hidden sm:flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 rounded-lg font-medium transition-all hover:shadow-[0_0_15px_rgba(22,163,74,0.3)] outline-none" data-testid="button-create-vcf-topbar">

  ...
  return (
    <div className="space-y-8 pb-10 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-8">
        ...
        >
          <button className="flex items-center gap-3 px-4 py-3 bg-card border border-primary/30 text-foreground rounded-xl font-medium shadow-[0_0_15px_rgba(22,163,74,0.1)] outline-none text-left">
            <User className="w-5 h-5 text-primary" />
            Profile & Account
          </button>
          <button className="flex items-center gap-3 px-4 py-3 text-muted-foreground hover:text-foreground hover:bg-secondary/50 rounded-xl font-medium transition-colors outline-none text-left">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <Button variant="outline" className="bg-secondary text-foreground hover:bg-secondary/80 border-0 h-9">
                    Upload Avatar
                  </Button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-background border border-border rounded-lg h-11 px-4 text-foreground focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      readOnly
                      className="w-full bg-background border border-border rounded-lg h-11 pl-10 pr-4 text-muted-foreground opacity-70 cursor-not-allowed focus:outline-none"
                    />
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="p-0">
              ...
              <div className="flex items-center justify-between p-6 border-b border-border/50">
                <div className="space-y-0.5">
                  <h4 className="text-foreground font-medium">Campaign Milestones</h4>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="border-2 border-primary bg-primary/5 rounded-xl p-4 flex items-center gap-4 cursor-pointer relative overflow-hidden">
                  ...
                  <div>
                    <h4 className="text-foreground font-bold">Light Mode</h4>
                    <p className="text-xs text-primary font-medium">Active Theme</p>
                  </div>
                </div>
                
                <div className="border-2 border-transparent bg-muted border-border rounded-xl p-4 flex items-center gap-4 cursor-not-allowed opacity-50 relative overflow-hidden group">
                  ...
                  <div>
                    <h4 className="text-foreground font-bold">System Default</h4>
          ...
          <div className="flex justify-end pt-4">
            <Button 
              onClick={handleSave}
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-8 h-12 shadow-[0_0_15px_rgba(22,163,74,0.2)]"
            >
              Save Preferences
            </Button>
          </div>

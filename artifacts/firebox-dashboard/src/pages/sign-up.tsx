    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-4">
      <div className="w-[440px] max-w-full bg-card border border-border rounded-2xl shadow-xl p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Start collecting VCF contacts today</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link href="/sign-in" className="text-primary font-semibold hover:text-primary/80">
            Sign in
          </Link>
        </p>
      </div>
